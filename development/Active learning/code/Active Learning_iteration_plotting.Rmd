...
Data_neg_mix <- read.csv("Data_neg_standards_unscaled.csv")
...
df_random_result <- read.csv(file = r"(C:\Users\wewa7216\OneDrive - Kruvelab\Desktop\PhD Wei-Chieh\WP_Active_Learning\Result_external\Sampling_20/Result_Random - Copy.csv)")
##------plot the result
...
df_clustering_result <- read.csv(file = paste0(saving_root, "Result_clustering.csv"))
